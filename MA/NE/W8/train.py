...
if __name__ == '__main__':
    ...
    opt_Swin_G = optim.Adam(Swin_G.parameters(), lr=args.learning_rate, betas=(0.5, 0.999))
    scheduler_Swin_G = optim.lr_scheduler.LambdaLR(opt_Swin_G, lr_lambda=lambda epoch: 0.95 ** epoch)
    ...
    if args.resume:
        ...
        opt_Swin_G.load_state_dict(checkpoint['opt_Swin_G'])
        scheduler_Swin_G.load_state_dict(checkpoint['scheduler_Swin_G'])
        ...
        with torch.no_grad():
            ...
            if S_mean > initial_ssim:
                ...
                checkpoint = {
                    ...
                    'Swin_G': Swin_G.state_dict(),
                    'opt_Swin_G': opt_Swin_G.state_dict(),
                    'scheduler_Swin_G': scheduler_Swin_G.state_dict()
                }
                torch.save(checkpoint, './ckpt/ckpt_Swin.pth')
