...
if __name__ == '__main__':
    ...
    opt_CNN_G = optim.Adam(CNN_G.parameters(), lr=args.learning_rate, betas=(0.5, 0.999))
    scheduler_CNN_G = optim.lr_scheduler.LambdaLR(opt_CNN_G, lr_lambda=lambda epoch: 0.95 ** epoch)

    if args.resume:
        path_checkpoint = './ckpt/ckpt_gatedCNN.pth'
        ...
        opt_CNN_G.load_state_dict(checkpoint['opt_CNN_G'])
        scheduler_CNN_G.load_state_dict(checkpoint['scheduler_CNN_G'])
        ...
        with torch.no_grad():
            ...
            if S_mean > initial_ssim:
                ...
                checkpoint = {
                    ...
                    'CNN_G': CNN_G.state_dict(),
                    'opt_CNN_G': opt_CNN_G.state_dict(),
                    'scheduler_CNN_G': scheduler_CNN_G.state_dict()
                }
                torch.save(checkpoint, './ckpt/ckpt_gatedCNN.pth')
