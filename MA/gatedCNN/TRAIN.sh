...
#SBATCH --job-name=gatedCNN
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --gres=gpu:a100:1
#SBATCH -o /home/woody/iwi5/%u/Inp_Mono/gatedCNN/window/gatedCNN-%j.out
#SBATCH -e /home/woody/iwi5/%u/Inp_Mono/gatedCNN/window/gatedCNN-%j.err
...
scp /scratch/$SLURM_JOB_ID/train/Legs/projection1_2.tif /home/woody/iwi5/iwi5069h/Check/
