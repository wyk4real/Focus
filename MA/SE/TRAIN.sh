...
#SBATCH --job-name=self_emb
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --gres=gpu:a100:1
#SBATCH -o /home/woody/iwi5/%u/Inp_Mono/Swwin/self_emb/window/self_emb-%j.out
#SBATCH -e /home/woody/iwi5/%u/Inp_Mono/Swwin/self_emb/window/self_emb-%j.err
...
scp /scratch/$SLURM_JOB_ID/train/Legs/projection4_1.tif /home/woody/iwi5/iwi5069h/Check/
